...
export default function SignupPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F6F5FA] relative flex items-center justify-center px-4 py-8 overflow-hidden">
      ...
      {/* Signup Container */}
      <div className="relative z-10 w-full max-w-[607px] h-[697px] flex-shrink-0 rounded-[50px] border-2 border-[rgba(216,223,233,0.50)] bg-gradient-to-b from-[rgba(216,223,233,0.25)] to-[rgba(216,223,233,0.00)] backdrop-blur-sm">
        <form onSubmit={handleSubmit} className="relative w-full h-full p-11">
          {/* First Name Input */}
          <div className="flex w-[520px] h-[72px] px-5 py-2.5 items-center rounded-[20px] bg-white absolute left-11 top-[54px]">
          ...
          {/* Last Name Input */}
          <div className="flex w-[520px] h-[72px] px-5 py-2.5 items-center rounded-[20px] bg-white absolute left-11 top-[143px]">
            <div className="flex flex-col w-full">
              <span className="text-[#212121] font-['Onest'] text-xl font-normal leading-normal">
                Last Name
              </span>
          ...
          {/* Email Input */}
          <div className="flex w-[520px] h-[72px] px-5 py-2.5 items-center rounded-[20px] bg-white absolute left-11 top-[232px]">
            <div className="flex flex-col w-full">
              <span className="text-[#212121] font-['Onest'] text-xl font-normal leading-normal">
                Email
              </span>
          ...
          {/* Password Input */}
          <div className="flex w-[520px] h-[72px] px-5 py-2.5 flex-col justify-center items-start gap-2 rounded-[20px] bg-white absolute left-11 top-[321px]">
            <span className="text-[#212121] font-['Onest'] text-xl font-normal leading-normal">
              Password
            </span>
            <input
          ...
          <div className="flex w-[520px] h-[72px] px-5 py-2.5 flex-col justify-center items-start gap-2 rounded-[20px] bg-white absolute left-11 top-[410px]">
            <span className="text-[#212121] font-['Onest'] text-xl font-normal leading-normal">
              Confirm Password
            </span>
            <input
          ...
          <button
            type="submit"
            className="flex w-[520px] h-[70px] px-5 py-2.5 justify-center items-center flex-shrink-0 rounded-[25px] border border-[#212121] bg-[#231F20] absolute left-11 top-[530px] cursor-pointer text-[#EFEFEF] text-center font-['Onest'] text-xl font-bold leading-normal hover:bg-[rgba(35,31,32,0.9)] transition-colors duration-300"
          >
            Sign up
          </button>

          {/* Login Link */}
          <div className="text-[#212121] font-['Onest'] text-xl font-medium leading-normal absolute left-[150px] top-[617px] w-[301px] h-[26px]">
